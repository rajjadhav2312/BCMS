...
if("valid".equals(msg)){
%>
	<script>swal('Sucessfully added to Cart','You can check your Cart','success');</script>
...
%>
	...
	ResultSet rs=stmt.executeQuery("select * from construction.product_info");
		...
		<div id="card1-section"
			...
			<div style="width: 50%; height: 50px; margin-top: 50px;">
				<a href="#"
					...
					Now</a> 
					<a href="cement_cart.jsp?id=<%=rs.getString("prod_id")%>"
